  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <Card className="flex-1 bg-amber-50 border-amber-200 shadow-lg shadow-slate-100 overflow-hidden relative">
          <div className="absolute top-0 left-0 w-1 h-full bg-amber-600"></div>
          <CardContent className="p-5 flex items-center gap-5">
            <div className="bg-amber-600/10 text-amber-700 p-3 rounded-2xl">
              <Calculator className="h-6 w-6" />
            </div>
            <div className="flex-1">
              <p className="text-sm font-bold tracking-tight text-amber-900">
                System Mode: Mobility Flows Expert (Erasmus+)
              </p>
              <p className="text-xs mt-1 text-amber-700/70">
                Optimized for Erasmus+ KA122/KA121/KA131 structures with activity-based budgeting and participant flows.
              </p>
            </div>
